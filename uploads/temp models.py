...
class Student(models.Model):
    sap = models.TextField(primary_key=True)
...
class Answer(models.Model):
    ...
    qpid = models.TextField()
    qno = models.IntegerField()
    marks_aquired = models.IntegerField()
...
class QuestionPaper(models.Model):
    qpid = models.TextField(primary_key = True)
